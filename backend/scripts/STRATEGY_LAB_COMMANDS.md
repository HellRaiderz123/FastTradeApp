...
```
docker exec -it fasttrade-backend python3 /app/scripts/discover_condition_strategies.py --timeframe Day --max-candidates 150 --top 5 --start-date 2023-09-11 --end-date 2026-03-23 --workers 12 --tsl-grid 0 --sl-grid 4,5 --tp-grid 10,12,15 --save-top
```

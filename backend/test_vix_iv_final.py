...
print("\n" + "="*100)
print("VIX/IV IMPACT ON STRATEGY DECISIONS TEST")
print("="*100)
...
print("  2. HIGH IV regimes better for spread strategies")
print("  3. LOW IV regimes unfavorable (wider spreads needed)")
print("  4. Signal enrichment includes market regime data")
